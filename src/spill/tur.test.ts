...
describe("tur", () => {
  ...
  it("går seks stopp og blir ferdig", () => {
    let tur = startTur({ nivaa: "forste", lydPa: true }, () => 0.1);
  ...
  it("øker og minker lomme og går aldri negativ", () => {
    let tur = startTur({ nivaa: "forste", lydPa: true }, () => 0.2);
  ...
  it("duell vinnes med to av tre og gir diamant", () => {
    let tur = startTur({ nivaa: "andre", lydPa: true }, () => 0.3);
    tur = startDuell(tur);
  ...
  it("melk følger verdi", () => {
    const tur = startTur({ nivaa: "forste", lydPa: true }, () => 0.4);
  ...
  it("harZombie følger planen", () => {
    const tur = startTur({ nivaa: "forste", lydPa: true }, () => 0.9);
